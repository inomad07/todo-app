...
import { EDIT, DELETE, TOGGLE, TODO_SUCCESSFULLY_UPDATED, TODO_SUCCESSFULLY_REMOVED,
    TODO_SUCCESSFULLY_TOGGLED, TODO_SUCCESSFULLY_UNTOGGLED } from '../../../common/constants'
...
const TodoList = (props) => {
    ...
    const toggle = (todo) => {
        ...
        if(!todo.done) {
            return setTimeout(() => toastr.success(TODO_SUCCESSFULLY_TOGGLED), 0);
        }
